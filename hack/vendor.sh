...
clone git github.com/docker/engine-api 7ceade06ea91c728fe6dee5a4e01107f44e7cfe0
...
clone git github.com/docker/distribution 33c4a6522e9247913fa0a9a2d78ef9a7aa98465f
